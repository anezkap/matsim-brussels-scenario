#!/bin/bash
#SBATCH --job-name="baseline_scenario_10pct"
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
RUN_ID="baseline_scenario_10pct"
BIKING_ALLOWANCE="0.35"
...
cd $TMPDIR/matsim-example-project/scenarios/brussels/baseline_scenario_10pct
...
java -Xms24G -Xmx24G \
     ...
     -jar ../../../matsim.jar run \
     --config config_baseline_scenario_10pct.xml \
     --yaml ../asc_params.yaml \
     --output $TMPDIR/matsim_run/runs/$RUN_ID \
     --runId $RUN_ID \
     --config:controler.lastIteration 1000 \
