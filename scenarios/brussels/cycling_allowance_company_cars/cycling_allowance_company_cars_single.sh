#!/bin/bash
#SBATCH --job-name="cycling_allowance_company_cars_single"
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
RUN_ID="cycling_allowance_company_cars_single"
BIKING_ALLOWANCE="0.65"
...
cd $TMPDIR/matsim-example-project/scenarios/brussels/cycling_allowance_company_cars
...
java -Xms24G -Xmx24G \
     ...
     -jar ../../../matsim.jar run \
     --config config_cycling_allowance_company_cars.xml \
