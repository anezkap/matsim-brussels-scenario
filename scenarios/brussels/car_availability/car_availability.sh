#!/bin/bash
#SBATCH --job-name="car_availability"
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
cd $TMPDIR/matsim-example-project/scenarios/brussels/car_availability
...
java -Xms24G -Xmx24G \
     ...
     -jar ../../../matsim.jar run \
     --config config_car_availability.xml \
